...
export default function Header (props) {
  ...
  return (
    <AppBar position='fixed' className='header-wrp'>
      <Toolbar className={classes.toolbar}>
        ...
        >
          {layoutState.isDarkActivated ? (
            <span
              className='burger-menu-icn'
              classes={{
                root: classNames(
                  classes.headerIcon,
            ...
            <span
              className='burger-menu-icn active'
              classes={{
                root: classNames(
                  classes.headerIcon,
                  classes.headerIconCollapse,
        ...
        <div className='rightmenu-wrp'>
          ...
          <div className='mailing-controls'>
            ...
            >
              <img className='avtar-img' src={avtarImg} alt='' />
            </IconButton>
            <Menu
              id='mail-menu'
